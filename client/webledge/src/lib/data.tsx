...
export const  useGetAccounts = ():{data:AccountSet | undefined, isLoading:boolean, error: string|undefined} => {
   return useSWR<AccountSet, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+'/accounts');
}
...
export const useGetTransaction = (transactionID:string |undefined):{
    ...
    return useSWR<TransactionResponse, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+'/transactions/'+transactionID);
}
...
export const useGetTransactionsOnAccountLedger = (accountID:string |undefined):{data:TransactionLedgerResponse | undefined, isLoading:boolean, error: string|undefined} => {
    return useSWR<TransactionLedgerResponse, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+'/transactions/account/'+accountID);
};

const accountTypesURL = new URL('/accounttypes', import.meta.env.VITE_APP_MIMIRLEDGER_API_URL);
...
export const  useGetReports = ():{data:ReportSet | undefined, isLoading:boolean, error: string|undefined} => {
    return useSWR<ReportSet, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+'/reports');
}
export const useGetReport = (reportID:string |undefined):{data:Report | undefined, isLoading:boolean, error: string|undefined} => {
    return useSWR<Report, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+'/reports/'+reportID);
}
...
export const useGetUnreconciledTransactionOnAccount = (accountID:string |undefined, date:string):{
    ...
    return useSWR<AccountReconcileResponse, string>(import.meta.env.VITE_APP_MIMIRLEDGER_API_URL+
